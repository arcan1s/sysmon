...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Create and install Kit SysMon by arcanis', 
            epilog='See INSTALL for more details')
    ...
    parser.add_argument('-o',  '--order',  dest='order', 
            help = 'Order of blocks in widget, format "1234567". Also you may disable any bar. Default is "1234567". Description:\
    ...
    parser.add_argument('-hi','--hddinfo', dest='hddinfo',
            help = 'Number of mount point in HDD bar ([1..3]). Default is "3"',
